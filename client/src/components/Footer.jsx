...
const COPY = {
  en: {
    ...
    privacyLink: "Read Privacy Policy", termsTitle: "Terms",
    ...
    termsLink: "Read Terms of Use", rights: "All rights reserved.", bottomPrivacy: "Privacy",
    bottomTerms: "Terms", bottomRefund: "Refunds", bottomContact: "Contact",
  ...
  hi: {
    ...
    privacyLink: "गोपनीयता नीति पढ़ें", termsTitle: "उपयोग के नियम",
    ...
    termsLink: "उपयोग के नियम पढ़ें", rights: "सर्वाधिकार सुरक्षित।", bottomPrivacy: "गोपनीयता",
    bottomTerms: "नियम", bottomRefund: "धनवापसी", bottomContact: "संपर्क",
  ...
  return (
    <footer className="siteFooter" id="help">
      <div className="footerTop">
        <div className="footerBrand"><div className="brandMark">H</div><div><h2>HimRideG</h2><p>{t.tagline}</p></div></div>
      ...
      <div className="footerLegalSummary">
        <details id="privacy"><summary>{t.privacyTitle}</summary><div className="footerLegalDisclosure"><p>{t.privacyText}</p><a href="/privacy/">{t.privacyLink}</a></div></details>
        <details id="terms"><summary>{t.termsTitle}</summary><div className="footerLegalDisclosure"><p>{t.termsText}</p><p>{t.otpText}</p><a href="/terms/">{t.termsLink}</a></div></details>
        <details id="cancellation-refund"><summary>{t.refund}</summary><div className="footerLegalDisclosure"><p>Applicable cancellation/no-show fees are shown before booking confirmation. Eligible online refunds are processed to the original payment method according to gateway and bank timelines. Mandatory consumer and statutory rights are not removed.</p><a href="/refund-cancellation/">{t.bottomRefund}</a></div></details>
        <details id="contact"><summary>{t.contact}</summary><div className="footerLegalDisclosure"><p>{t.address}</p><a href="mailto:himrideg@gmail.com">himrideg@gmail.com</a></div></details>
      </div>

      <div className="footerBottom"><p>© {new Date().getFullYear()} HimRideG. {t.rights}</p><div><a href="/privacy/">{t.bottomPrivacy}</a><a href="/terms/">{t.bottomTerms}</a><a href="/refund-cancellation/">{t.bottomRefund}</a><a href="/contact/">{t.bottomContact}</a></div></div>
    </footer>
  );
}
